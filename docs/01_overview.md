...
- **[Prizes](/overview#grand-prize-150000)**: $575,000 in prizes, including a $475,000 Grand Prize and $100,000 in [Progress Prizes](/overview#progress-prizes-100000). The first progress prize is a [$50,000 ink detection competition on Kaggle](https://www.kaggle.com/competitions/vesuvius-challenge-ink-detection).
