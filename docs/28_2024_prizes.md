...
Submissions are evaluated monthly, and multiple submissions/awards per month are permitted. The next deadline is 11:59pm Pacific, August 31, 2024! Submit using [this form](https://forms.gle/MV9L2TjtQPAuTsAt9).
