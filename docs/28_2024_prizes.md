...
* **[Volume Cartographer](https://github.com/educelab/volume-cartographer):**
  * Off-axis segmentation (allowing the slice direction to vary during segmentation). Nice starting point: OME-Zarr as input image format.
...
Submissions are evaluated monthly, and multiple submissions/awards per month are permitted. The next deadline is 11:59pm Pacific, April 30, 2024! Submit using [this form](https://forms.gle/r22qTeo3ifvS6AXYA).
