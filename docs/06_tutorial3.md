...
* `<segmentationnumber>.mtl` is a text file that contains information about the material, such as opacity, reflectivity, and points to the texture file (this tif in the previous line)
