...
* [Ben’s Segmentation Tutorial.](https://www.youtube.com/watch?v=gdQmepxWhuY) Ben (@Hari_Seldon on Discord) goes into great detail on how to do segmenting.
...
* [Crackle labels.](https://dl.ash2txt.org/community-uploads/bruniss/) Made by Sean Johnson (@bruniss on Discord) using Vesuvius Kintsugi.
